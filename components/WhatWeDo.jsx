      ...
      <div className="relative w-full max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 cairo">
          ...
          <motion.div
            ...
            className="group relative transform-gpu bg-white/70 backdrop-blur-xl border border-black/5 rounded-3xl p-10 shadow-sm hover:shadow-2xl transition-all duration-300"
          >
            <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-black text-white mb-6 group-hover:scale-110 transition-transform duration-300">
              ▲
            </div>
        ...
        >
          <a
            href="#contact"
            className="
              group relative transform-gpu inline-flex items-center justify-center
              overflow-hidden
              rounded-full
